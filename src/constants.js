...
let SIDE_MARGIN_WIDTH = (SCREEN_WIDTH - TOTAL_TILE_WIDTH * TOTAL_POSITIONS_WIDE) / 2; //25;
let TOP_MARGIN_HEIGHT = SCREEN_HEIGHT - TILE_HEIGHT * (TOTAL_POSITIONS_HIGH - 1) - BOTTOM_MARGIN_HEIGHT;
