...
function primeTesting() {
    ...
    console.assert(testArray.length == 1, "getPrimesOfNumber(3) should return array of length 1, instead is length " + testArray.length.toString());
    console.assert(testArray[0] == 3, "getPrimesOfNumber(3) should return 3, instead returns " + testArray.toString());
    testArray = getPrimesOfNumber(5);
    console.assert(testArray.length == 1, "getPrimesOfNumber(5) should return array of length 1, instead is length " + testArray.length.toString());
    console.assert(testArray[0] == 5, "getPrimesOfNumber(5) should return 5, instead returns " + testArray.toString());
    testArray = getPrimesOfNumber(31);
    console.assert(testArray.length == 1, "getPrimesOfNumber(31) should return array of length 1, instead is length " + testArray.length.toString());
    console.assert(testArray[0] == 31, "getPrimesOfNumber(31) should return 31, instead returns " + testArray.toString());
    testArray = getPrimesOfNumber(37);
    console.assert(testArray.length == 1, "getPrimesOfNumber(37) should return array of length 1, instead is length " + testArray.length.toString());
    console.assert(testArray[0] == 37, "getPrimesOfNumber(37) should return 37, instead returns " + testArray.toString());
    testArray = getPrimesOfNumber(101);
    console.assert(testArray.length == 1, "getPrimesOfNumber(101) should return array of length 1, instead is length " + testArray.length.toString());
    console.assert(testArray[0] == 101, "getPrimesOfNumber(101) should return 101, instead returns " + testArray.toString());
}
...
function compositeTesting() {
    ...
    expectedArray = [2, 2, 3];
    console.assert(testArray.length == 3, "getPrimesOfNumber(12) should return array of length 3, instead is length " + testArray.length.toString());
    ...
    console.assert(testArray.length == 4, "getPrimesOfNumber(210) should return array of length 4, instead is length " + testArray.length.toString());
    ...
    console.assert(testArray.length == 3, "getPrimesOfNumber(970) should return array of length 3, instead is length " + testArray.length.toString());
...
function getMostFactors() {
    let mostFactors = 0;
    for (let i = 0; i < 1000; i++) {
        let array = getPrimesOfNumber(i);
        if (mostFactors < array.length ) {
            mostFactors = array.length;
        }
    }
    console.log("Most factors is: " + mostFactors);
}
